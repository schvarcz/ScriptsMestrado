...
vector<double> VisualOdometryStereo::estimateMotion (vector<IMatcher::p_match> p_matched) {
...
vector<int32_t> VisualOdometryStereo::getInlier(vector<IMatcher::p_match> &p_matched,vector<double> &tr) {
...
VisualOdometryStereo::result VisualOdometryStereo::updateParameters(vector<IMatcher::p_match> &p_matched,vector<int32_t> &active,vector<double> &tr,double step_size,double eps) {
...
void VisualOdometryStereo::computeObservations(vector<IMatcher::p_match> &p_matched,vector<int32_t> &active) {
