...
public:
  ...
  bool process (std::vector<IMatcher::p_match> p_matched_) {
...
protected:
  ...
  virtual std::vector<double> estimateMotion (std::vector<IMatcher::p_match> p_matched) = 0;
  ...
  std::vector<IMatcher::p_match>  p_matched;  // feature point matches
