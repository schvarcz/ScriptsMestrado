...
void Matcher::computePriorStatistics (vector<IMatcher::p_match> &p_matched,int32_t method) {
...
void Matcher::matching (int32_t *m1p,int32_t *m2p,int32_t *m1c,int32_t *m2c,
                        ...
                        vector<IMatcher::p_match> &p_matched,int32_t method,bool use_prior,Matrix *Tr_delta) {
    ...
    for (i1c=0; i1c<n1c; i1c++) {
      ...
      if (i1c2==i1c) {
        ...
        if (*(M+getAddressOffsetImage(u1c,v1c,dims_c[0]))==0) {
          p_matched.push_back(IMatcher::p_match(u1p,v1p,i1p,-1,-1,-1,u1c,v1c,i1c,-1,-1,-1));
    ...
    for (i1c=0; i1c<n1c; i1c++) {
      ...
      if (i1c2==i1c) {
        ...
        if (u1c>=u2c) {
          ...
          // add match if this pixel isn't matched yet
          if (*(M+getAddressOffsetImage(u1c,v1c,dims_c[0]))==0) {
            p_matched.push_back(IMatcher::p_match(-1,-1,-1,-1,-1,-1,u1c,v1c,i1c,u2c,v2c,i2c));
            *(M+getAddressOffsetImage(u1c,v1c,dims_c[0])) = 1;
          }
        }
      }
    ...
    for (i1p=0; i1p<n1p; i1p++) {
      ...
      if (i1p2==i1p) {
        ...
        if (u1p>=u2p && u1c>=u2c) {
          ...
          // add match
          p_matched.push_back(IMatcher::p_match(u1p,v1p,i1p,u2p,v2p,i2p,
...
void Matcher::removeOutliers (vector<IMatcher::p_match> &p_matched,int32_t method) {
  ...
  vector<IMatcher::p_match> p_matched_copy;
...
void Matcher::refinement (vector<IMatcher::p_match> &p_matched,int32_t method) {
  ...
  vector<IMatcher::p_match> p_matched_copy = p_matched;
  p_matched.clear();
  ...
  // for all matches do
  for (vector<IMatcher::p_match>::iterator it=p_matched_copy.begin(); it!=p_matched_copy.end(); it++) {
