...
private:
  ...
  // matching functions
  void computePriorStatistics (std::vector<IMatcher::p_match> &p_matched,int32_t method);
  ...
  void matching (int32_t *m1p,int32_t *m2p,int32_t *m1c,int32_t *m2c,
                 ...
                 std::vector<IMatcher::p_match> &p_matched,int32_t method,bool use_prior,Matrix *Tr_delta = 0);

  // outlier removal
  void removeOutliers (std::vector<IMatcher::p_match> &p_matched,int32_t method);
  ...
  void relocateMinimum(const uint8_t* I1_du,const uint8_t* I1_dv,const int32_t* dims1,
                       ...
                       float       &u2,float       &v2,
                       uint8_t* desc_buffer);
  void refinement (std::vector<IMatcher::p_match> &p_matched,int32_t method);
