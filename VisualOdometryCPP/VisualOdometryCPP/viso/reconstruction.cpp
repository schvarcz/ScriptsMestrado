...
void Reconstruction::update (vector<IMatcher::p_match> p_matched,Matrix Tr,int32_t point_type,int32_t min_track_length,double max_dist,double min_angle) {
  ...
  for (vector<IMatcher::p_match>::iterator m=p_matched.begin(); m!=p_matched.end(); m++)
